 ...
 */
public class TestRolodexDeleteAll extends TestTemplate {

    public TestRolodexDeleteAll() {
        super();
    ...
    public void test() throws SQLException {
        ...
        this.Person_Delete_All();
        this.Address_Delete_All();
        this.Person_Select_All_Print();
        this.Address_Select_All_Print();
        this.AddressUsage_Select_All_Print();
    ...
    public void Person_Delete_All() throws SQLException {
        CallableStatement proc = connection.prepareCall("{CALL Person_Delete_All()}");
        proc.execute();
        proc.close();
    }
    ...
    public void Address_Delete_All() throws SQLException {
        CallableStatement proc = connection.prepareCall("{CALL Address_Delete_All()}");
        proc.execute();
        proc.close();
    }
    ...
    public void AddressUsage_Delete_All() throws SQLException {
        CallableStatement proc = connection.prepareCall("{CALL AddressUsage_Delete_All()}");
        proc.execute();
        proc.close();
    }
