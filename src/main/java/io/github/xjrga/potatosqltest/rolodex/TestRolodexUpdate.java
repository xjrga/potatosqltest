 ...
 */
public class TestRolodexUpdate extends TestTemplate {

    public TestRolodexUpdate() {
        super();
    ...
    public void test() throws SQLException {
        ...
        this.Person_Update(personId, "User is updated");
        this.Address_Update(addressId, "User Address is updated");
        millis = Calendar.getInstance().getTimeInMillis();
        date = new Date(millis);
        this.AddressUsage_Update(personId, addressId, addressUsageType, date);
        this.Person_Select_All_Print();
        this.Address_Select_All_Print();
        this.AddressUsage_Select_All_Print();
    ...
    public void Person_Update(Integer PersonId, String PersonName) throws SQLException {
        CallableStatement proc = connection.prepareCall("{CALL Person_Update( ?, ? )}");
    ...
    public void Address_Update(Integer AddressId, String AddressDetail) throws SQLException {
        CallableStatement proc = connection.prepareCall("{CALL Address_Update( ?, ? )}");
    ...
    public void AddressUsage_Update(Integer PersonId, Integer AddressId, Integer AddressUsageType, Date AddressUsageStartDate) throws SQLException {
        CallableStatement proc = connection.prepareCall("{CALL AddressUsage_Update( ?, ?, ?, ? )}");
        proc.setInt(1, PersonId);
        proc.setInt(2, AddressId);
        proc.setInt(3, AddressUsageType);
        proc.setDate(4, AddressUsageStartDate);
